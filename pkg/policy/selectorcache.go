...
type CachedSelector interface {
	...
	// IsWildcard returns true if the CachedSelector selects
	// all endpoints.
	IsWildcard() bool
...
// XXXMatches returns true if the CachedSelector matches given labels. This
// always return false
func (s *selectorManager) XXXMatches(labels labels.LabelArray) bool {
	return false
}
